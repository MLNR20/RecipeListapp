...
class DeleteDisplay : AppCompatActivity() {

    private lateinit var binding: ActivityDeleteDisplayBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDeleteDisplayBinding.inflate(layoutInflater)
